...
const Elevate = () => {
    ...
    */
    ...
    let elevator = new Elevator({
            ...
            mainAudio: "/src/audio/Sick Sick Mind.mp3",
            endAudio: "/src/audio/Hampden Parks.mp3"
    })
    
    const elevatorButton = () => {
        elevator.elevate();
        console.log("button pressed, going up")
    }
    ...
    return ( 
        <div>
            ...
            <div class="elevator-container">
                <button class="elevator-button" onclick={elevatorButton()}></button>
            </div>
